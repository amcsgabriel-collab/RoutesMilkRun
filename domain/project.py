...
class Project:
    ...
    def create_pattern(self, shippers_key: list[str]):
        return RoutePattern(self.current_scenario.get_shippers_from_key(shippers_key), self.plant)

    def create_route(self, shippers_key: list[str], vehicle_id: str):
        return DirectRoute(self.create_pattern(shippers_key), self.get_vehicle_by_id(vehicle_id))
